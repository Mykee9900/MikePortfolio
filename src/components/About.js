    ...
    return (
        <div className="mt-[100px]">
            ...
            <div className="flex flex-col items-center sm:flex-col md:flex-row lg:flex-row justify-around w-full my-[80px]">
                <img className="h-[150px] sm:h-[250px] md:h-[350px] lg:h-[500px] border-8 border-gray-500 rounded-2xl " src="https://mikeportfoliomedia.s3.us-east-1.amazonaws.com/aboutPhoto.jpg" alt="Profile picture" />
