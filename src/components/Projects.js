        ...
        // import toDoList from "../media/toDoList.mp4";
        // import bookLab from "../media/bookLab.mp4";
        // import movieMake from "../media/MovieMaker.mp4";
        // import taskVid from "../media/TaskVid.mp4";
                        ...
                        <div>
                            ...
                            <div className="overflow-x-auto mt-6 flex lg:flex-row sm:flex-col md:flex-row justify-around max-w-[100vw]">
                                <figure className="min-w-[280px] bg-opacity-20 bg-cyan-200 p-4 m-4 rounded-[20px] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 cursor-pointer">
                                    ...
                                    <video className="rounded-[20px] border-gray-600 border-8 my-4 w-[270px] h-[150px]" src="https://mikeportfoliomedia.s3.us-east-1.amazonaws.com/affirmGen.mp4" controls aria-label="A project that generates affirmations"></video>
                                ...
                                <h6 className="text-xl text-center">Calculator</h6>
                                    <video className="rounded-[20px] border-gray-600 border-8 my-4 w-[270px] h-[165px]" src="https://mikeportfoliomedia.s3.us-east-1.amazonaws.com/calculator.mp4" controls aria-label="A project that is a calculator"></video>
                                ...
                                <figure className="min-w-[280px] bg-opacity-20 bg-cyan-200 p-4 m-4 rounded-[20px] transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 duration-300 cursor-pointer">
                                    ...
                                    <video className="rounded-[20px] border-gray-600 border-8 my-4 w-[270px] h-[161px]" src="https://mikeportfoliomedia.s3.us-east-1.amazonaws.com/toDoList.mp4" controls aria-label="A project that is used as a ToDo List"></video>
                        ...
                        <div className="mb-9">
                            ...
                            <div className="overflow-x-auto flex flex-row overflow-auto lg:flex-row sm:flex-col md:flex-row justify-around mt-6 max-w-[100vw]">
                                ...
                                <h6 className="text-xl text-center">Book Lab</h6>
                                    <video className="rounded-[20px] border-gray-600 border-8 my-4 w-[270px] h-[160px]" src="https://mikeportfoliomedia.s3.us-east-1.amazonaws.com/bookLab.mp4" controls aria-label="A project that has crud operations to view books"></video>
